...
<div class="hero-section text-center py-4 mb-4" style="background: linear-gradient(rgba(0, 100, 0, 0.9), rgba(0, 100, 0, 0.9)); color: #FFD700; border-radius: 10px;">
    <div class="container">
        <img src="{{ asset('images/csu-logo.png') }}" alt="CSU Logo" class="mb-3" style="max-width: 120px;">
        <h1 class="display-4 mb-2" style="color: #FFD700; font-size: 2.5rem;">Caraga State University Lost and Found</h1>
        <p class="lead mb-2" style="color: #fff;">Finding your items has never been easier</p>
        <p class="lead mb-3" style="color: #fff;">No need to create an account, just post and wait</p>
    </div>
</div>

<div class="text-center mb-4">
    <a href="{{ route('how-it-works') }}" class="btn btn-lg btn-how-it-works">
    ...
    <div class="card-header bg-white py-2">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                ...
                <p class="mb-0" style="font-size: 0.875rem; color: #666;">Active Lost and Found Items</p>
            </div>
            <div class="d-flex gap-2">
                <div class="btn-group">
                    ...
                    <a href="{{ route('posts.index', ['sort' => 'oldest']) }}" 
                ...
                <div class="col-12">
                    <div class="search-box">
                        <div class="input-group">
                            ...
                            @if(request('search'))
                                <a href="{{ route('posts.index', array_merge(request()->except('search'), ['page' => 1])) }}" 
                ...
                <div class="card h-100">
                    ...
                    <div class="card-header py-2">
                        ...
                        <small class="text-muted">
                            <i class="fas fa-clock me-1"></i>{{ $post->created_at->format('M d, Y h:i A') }}
                        </small>
                    </div>
                    <div class="card-body py-2">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            @elseif($post->status === 'pending_claim')
                                <span class="badge bg-warning">Pending Claim</span>
                            @elseif($post->status === 'pending_return')
...
@else
    <div class="alert alert-info">
        No active items found. <a href="{{ route('posts.create') }}" class="alert-link">Post a lost or found item</a>
    </div>
@endif
